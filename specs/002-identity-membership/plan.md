...
**Primary Dependencies**: NestJS + Drizzle ORM — **fixed**, unchanged from slice 001. No Cognito SDK is introduced by this slice: verifying a Cognito token is slice
...
| --- | --------------------------------------------- | ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| I   | Spec-First Delivery (NON-NEGOTIABLE)          | ✅ PASS                              | `spec.md` precedes this plan. `master-user-story-catalog.md` carries `US18-EP12-ASC-AcceptInvitation`, `US19-EP12-ASC-SelectActiveTenant`, `US16-EP00-FND-SeedFirstAdministrator`, `US13-EP00-FND-AssignRoleToUser` and `US15-EP00-FND-AuditPermissionChange`; every story this slice delivers is traceable. **US13/US15 added 2026-08-21** — this slice always implemented archetype change (its matrix row) and its audit action (`membership.archetype_changed`), but the original entry claimed only three of the five stories it actually delivers. Corrected while specifying `004-authorization-entitlements`. |
...
- **Principle II's "enforced at the data layer" is now true of membership
  _creation_, not only membership _reads_.** 001 already enforced isolation on
